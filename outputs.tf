output "current_kubernetes_version" {
  ...
  value       = { for k, v in module.aks : k => v.current_kubernetes_version }
}

output "fqdn" {
  description = "The FQDN of the Azure Kubernetes Managed Cluster"
  value       = { for k, v in module.aks : k => v.fqdn }
}

output "http_application_routing_zone_name" {
  description = "The Zone Name of the HTTP Application Routing"
  value       = { for k, v in module.aks : k => v.http_application_routing_zone_name }
}

output "identity_principal_id" {
  description = "The Principal ID associated with this Managed Service Identity"
  value       = { for k, v in module.aks : k => v.identity_principal_id }
}

output "identity_tenant_id" {
  description = "The Tenant ID associated with this Managed Service Identity"
  value       = { for k, v in module.aks : k => v.identity_tenant_id }
}
...
output "ingress_application_gateway_identity_client_id" {
  ...
  value       = { for k, v in module.aks : k => v.ingress_application_gateway_identity_client_id }
}
...
output "ingress_application_gateway_identity_object_id" {
  ...
  value       = { for k, v in module.aks : k => v.ingress_application_gateway_identity_object_id }
}
...
output "ingress_application_gateway_identity_user_assigned_identity_id" {
  ...
  value       = { for k, v in module.aks : k => v.ingress_application_gateway_identity_user_assigned_identity_id }
}
...
output "key_vault_secrets_provider_secret_identity_client_id" {
  ...
  value       = { for k, v in module.aks : k => v.key_vault_secrets_provider_secret_identity_client_id }
}
...
output "key_vault_secrets_provider_secret_identity_object_id" {
  ...
  value       = { for k, v in module.aks : k => v.key_vault_secrets_provider_secret_identity_object_id }
}
...
output "key_vault_secrets_provider_secret_identity_user_assigned_identity_id" {
  ...
  value       = { for k, v in module.aks : k => v.key_vault_secrets_provider_secret_identity_user_assigned_identity_id }
}

output "kube_admin_config" {
  description = "The kube_admin_config block for the Azure Kubernetes Managed Cluster"
  value       = { for k, v in module.aks : k => v.kube_admin_config }
}

output "kube_admin_config_raw" {
  description = "Raw Kubernetes config for the admin account"
  value       = { for k, v in module.aks : k => v.kube_admin_config_raw }
  sensitive   = true
}
...
output "kubelet_identity_client_id" {
  ...
  value       = { for k, v in module.aks : k => v.kubelet_identity_client_id }
}

output "kubelet_identity_object_id" {
  description = "The Object ID of the user-defined Managed Identity assigned to the Kubelets"
  value       = { for k, v in module.aks : k => v.kubelet_identity_object_id }
}
...
output "oms_agent_identity_client_id" {
  ...
  value       = { for k, v in module.aks : k => v.oms_agent_identity_client_id }
}

output "oms_agent_identity_object_id" {
  description = "The Object ID of the user-defined Managed Identity used by the OMS Agents"
  value       = { for k, v in module.aks : k => v.oms_agent_identity_object_id }
}
...
output "web_app_routing_web_app_routing_identity_client_id" {
  ...
  value       = { for k, v in module.aks : k => v.web_app_routing_web_app_routing_identity_client_id }
}
...
output "web_app_routing_web_app_routing_identity_object_id" {
  ...
  value       = { for k, v in module.aks : k => v.web_app_routing_web_app_routing_identity_object_id }
}
...
output "web_app_routing_web_app_routing_identity_user_assigned_identity_id" {
  ...
  value       = { for k, v in module.aks : k => v.web_app_routing_web_app_routing_identity_user_assigned_identity_id }
}
